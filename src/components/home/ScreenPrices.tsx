...
const ScreenPrices = () => {
  const phoneScreens = [
    ...
    },
    {
      ...
      color: "bg-red-600", 
      models: [
        { name: "P50 Pro", glass: "3200 ₽", display: "5800 ₽", availability: "Под заказ" },
        { name: "P40 Pro", glass: "2800 ₽", display: "4900 ₽", availability: "Под заказ" },
        { name: "Nova 9", glass: "2200 ₽", display: "3800 ₽", availability: "В наличии" },
        { name: "Y6p", glass: "1400 ₽", display: "2400 ₽", availability: "В наличии" },
        { name: "Y5p", glass: "1200 ₽", display: "2100 ₽", availability: "В наличии" },
        { name: "Honor 50", glass: "2000 ₽", display: "3500 ₽", availability: "Под заказ" }
      ]
    }
  ];
