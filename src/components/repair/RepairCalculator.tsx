...
const RepairCalculator: React.FC<RepairCalculatorProps> = ({ isOpen, onClose }) => {
  ...
  const brands = [
    ...
    { name: 'Xiaomi', models: ['Xiaomi 13 Pro', 'Xiaomi 13', 'Xiaomi 12', 'Redmi Note 12 Pro', 'Redmi Note 12', 'Redmi Note 11', 'Redmi 12C', 'POCO X5 Pro'] },
    { name: 'Huawei', models: ['P50 Pro', 'P40 Pro', 'Nova 9', 'Y6p', 'Y5p', 'Honor 50'] }
  ];
